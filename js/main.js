(function(){
    ...
    function setChart(csvData, colorScale){
        // Create a scale for X-axis, mapping units to coordinates
        var xScale = d3.scaleBand()
            .range([0, chartInnerWidth])
            .paddingInner(0.1)
            .domain(csvData.map(function(d) { return d.WMU_NY_UNIT; })); // Use the UNIT field
        ...
        var xAxisGroup = chart.append("g")
            .attr("class", "x axis")
            .attr("transform", "translate(" + leftPadding + "," + (chartInnerHeight + topBottomPadding * 2) + ")")
            .call(xAxis);
    ...
    function updateChart(bars, n, colorScale){
        ...
        // Update chart title with actual field name
        var chartTitle = d3.select(".chartTitle")
            .text("Harvests: " + expressed);
    };
